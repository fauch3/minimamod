...
cardsCheckboxes.forEach((checksBooleans, index) => {
  if(localStorage.getItem(checksBooleans[index]) ) {
    ...
    //myCheck.checked = true;
    faitCheck(checkBox,checkBool, card);
...
//replace w a num.
function faitCheck(checkBox, checkBool, card) {
...
function faitCheck(num) {
  faitCheck(CardsCheckboxes[num], checksBooleans[num], cardsList[num])

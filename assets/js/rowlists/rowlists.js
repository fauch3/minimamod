...
CardsCheckboxes.forEach((cards, index) => {
  ...
  if(localStorage.getItem(checksBooleans[index])) {
    ...
    console.log('exists');
    console.log(document.getElementById(CardsCheckboxes[index]).checked)
    ...
    //myCheck.checked = true;
    faitCheck(checkBox,checkBool, text, card, true, index);
...
//replace w a num.
function faitCheck(checkBox, checkBool, text, card, optio=false, ind=-1) {
  ...
  */
  ...
  //text = document.getElementById(String(text));
  ...
  /*
  checkBox = document.getElementById(CardsCheckboxes[ind]);
  if(optio){
    checkBox.checked=true;
  }
  ///
  ...
  */
  ...
  //var checkBox_ = document.getElementById(checkBox);
...
function faitCheck2(num) {
  ...
  faitCheck(document.getElementById(CardsCheckboxes[num]), checksBooleans[num], document.getElementById(textsList[num]),
  document.getElementById(cardsList[num]));
...
function faitCheck4(num) {
  console.log('faitcheck surcharge 4');
  faitCheck2(num);
}
